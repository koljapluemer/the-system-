...
/// Ports the triage flow from the old ScratchpadTriage.vue exactly: load the
/// untriaged queue once, then repeatedly pop a random note and act on it.
class ScratchpadTriageNotifier extends Notifier<TriageState> {
  ...
  Future<void> _init() async {
    ...
    final queue = await notes.listScratchpadUntriaged(_folder);
